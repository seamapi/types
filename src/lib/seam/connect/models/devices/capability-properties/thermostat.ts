    ...
    temperature_threshold: z
      .object({
        lower_limit_celsius: z.number().nullable()
          .describe(`Lower limit in °C within the current [temperature threshold](https://www.seam.co/docs/capability-guides/thermostats/setting-and-monitoring-temperature-thresholds) set for the thermostat.
          `),
        lower_limit_fahrenheit: z.number().nullable()
          .describe(`Lower limit in °F within the current [temperature threshold](https://www.seam.co/docs/capability-guides/thermostats/setting-and-monitoring-temperature-thresholds) set for the thermostat.
          `),
        upper_limit_celsius: z.number().nullable()
          .describe(`Upper limit in °C within the current [temperature threshold](https://www.seam.co/docs/capability-guides/thermostats/setting-and-monitoring-temperature-thresholds) set for the thermostat.
          `),
        upper_limit_fahrenheit: z.number().nullable()
          .describe(`Upper limit in °F within the current [temperature threshold](https://www.seam.co/docs/capability-guides/thermostats/setting-and-monitoring-temperature-thresholds) set for the thermostat.
          `),
      })
      .optional().describe(`
          ---
